...
let dateValue = 50;
const popularitySlider = document.querySelectorAll(".custom-slider")[0];
const dateSlider = document.querySelectorAll(".custom-slider")[1];
...
function _debounceSlider(fn, delay = 350) {
    clearTimeout(_sliderDebounceTimer);
    _sliderDebounceTimer = setTimeout(fn, delay);
}

//JSE slider nem mukodik help, más logic kell
if (popularitySlider) {
